...
![Profile Views](https://komarev.com/ghpvc/?username=gfrrmd&label=Profile+Views&color=6c63ff&style=flat)

---

## About

I'm a developer based in Jakarta focused on building web applications, Telegram bots, and AI-integrated tools. Currently learning and expanding my skills in full-stack development.

- Working with **Node.js**, **Python**, and modern web technologies
- Building **Telegram bots** and experimenting with **LLM-powered applications**
- Deploying via **Railway**, managing data with **MongoDB** and **PostgreSQL**
- Open to collaboration and continuously improving
